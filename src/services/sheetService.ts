...
export const GOOGLE_SCRIPT_URL = '14OnwsB5mWfSnUDWg-PHfLmjMGKLDgHUNHVGpb4zNiZk';

// OCR SPECIFIC URL (Provided by User)
export const OCR_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzJWrbPV_IQ2eGFx6hUYo6ZBaSPkMg5FkggTks_C8nZG-8CvRCXXrOVvqOv4G8ixoYi/exec';
...
/**
 * Upload PDF to Google Apps Script for OCR
 */
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = async () => {
      try {
        ...
        const payload = {
          action: 'ocr',
          base64Data: base64Raw, // Gửi full Data URI
          fileName: file.name,
        ...
        const response = await fetch(OCR_SCRIPT_URL, {
          method: 'POST',
